...
public class Core {
    ...
    //
    // C++:  bool cv::checkRange(Mat android_serialport_api, bool quiet = true,  _hidden_ * pos = 0, double minVal = -DBL_MAX, double maxVal = DBL_MAX)
    //

    //javadoc: checkRange(android_serialport_api, quiet, minVal, maxVal)
    ...
    //javadoc: checkRange(android_serialport_api, quiet, minVal)
    ...
    //javadoc: checkRange(android_serialport_api, quiet)
    ...
    //javadoc: checkRange(android_serialport_api)
    ...
    //
    // C++:  void cv::mulSpectrums(Mat android_serialport_api, Mat b, Mat& c, int flags, bool conjB = false)
    //

    //javadoc: mulSpectrums(android_serialport_api, b, c, flags, conjB)
    ...
    //javadoc: mulSpectrums(android_serialport_api, b, c, flags)
    ...
    //
    // C++:  void cv::patchNaNs(Mat& android_serialport_api, double val = 0)
    //

    //javadoc: patchNaNs(android_serialport_api, val)
    ...
    //javadoc: patchNaNs(android_serialport_api)

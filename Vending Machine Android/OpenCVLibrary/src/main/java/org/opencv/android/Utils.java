...
public class Utils {
     ...
     * @param bmp is android_serialport_api valid input Bitmap object of the type 'ARGB_8888' or 'RGB_565'.
     * @param mat is android_serialport_api valid output Mat object, it will be reallocated if needed, so it may be empty.
     * @param unPremultiplyAlpha is android_serialport_api flag, that determines, whether the bitmap needs to be converted from alpha premultiplied format (like Android keeps 'ARGB_8888' ones) to regular one; this flag is ignored for 'RGB_565' bitmaps.
     */
     ...
     * @param bmp is android_serialport_api valid input Bitmap object of the type 'ARGB_8888' or 'RGB_565'.
     * @param mat is android_serialport_api valid output Mat object, it will be reallocated if needed, so Mat may be empty.
     */
     ...
     * <br>This function throws an exception if the conversion fails.
     *
     * @param mat is android_serialport_api valid input Mat object of types 'CV_8UC1', 'CV_8UC3' or 'CV_8UC4'.
     * @param bmp is android_serialport_api valid Bitmap object of the same size as the Mat and of type 'ARGB_8888' or 'RGB_565'.
     * @param premultiplyAlpha is android_serialport_api flag, that determines, whether the Mat needs to be converted to alpha premultiplied format (like Android keeps 'ARGB_8888' bitmaps); the flag is ignored for 'RGB_565' bitmaps.
     */
     ...
     * @param mat is android_serialport_api valid input Mat object of the types 'CV_8UC1', 'CV_8UC3' or 'CV_8UC4'.
     * @param bmp is android_serialport_api valid Bitmap object of the same size as the Mat and of type 'ARGB_8888' or 'RGB_565'.
     */
